...
SEMOPS_COP_SMOKE_SAPIENT_HTTP_ENABLED="$SEMOPS_SAPIENT_ENABLED" \
  go test ./internal/smoke/cop -run 'TestHostedCOP(SnapshotReflects(MAVLinkUDP|CoTUDP|ScenarioRunner|ADSBHTTPProvider|HADRSharedAirspace)|ComponentPrometheusMetricsReflectFeedFlow)' -count=1 -v
