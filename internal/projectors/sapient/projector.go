...
func (p *Projector) trackTriples(
	...
	triples := []message.Triple{
		...
		p.triple(trackID, cop.TimeObservationRecorded, when, when, confidence),
		p.triple(trackID, cop.TrackPosition, wktPoint(lat, lon), when, confidence),
		p.triple(trackID, cop.GeoLocationLatitude, lat, when, confidence),
		p.triple(trackID, cop.GeoLocationLongitude, lon, when, confidence),
