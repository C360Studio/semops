# semlink-live-companion-demo-ingest Specification

## Purpose
Define the SemOps-side handoff for SemLink-generated companion demo artifacts, including mixed SITL/source-fidelity
labels, COP display posture, and the boundary between artifact ingest and SemLink-owned runtime orchestration.
## Requirements
