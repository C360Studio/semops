...
Define the accepted MVP SemLink-to-SemOps companion readback contract, its
standards-mapping rules, feedback gate, CS API/SemConnect projection boundary,
and CS API promotion score for ArduPilot `AUTOPILOT_VERSION` readback intent.
