...
- [x] 6.58 Split broader EDXL beyond CAP into a later feed-validation gate if product needs justify it
...
- [x] 8.6 Run adversarial review before SAPIENT, KLV, semantic, or standards-conformance claims are demoed
...
- [x] 9.1 File manifest/tier placement ask only if the scope gate proves it is useful
      Deferred by `reviews/2026-07-08-upstream-ask-deferral-refresh.md`; current evidence says local health/source
      state still answers the placement question. Closed without filing by
      `reviews/2026-07-09-semstreams-beta145-runtime-reconcile-review.md`.
- [x] 9.2 File escalation event/status vocabulary ask only after inference evidence proves the need
      Deferred by `reviews/2026-07-08-upstream-ask-deferral-refresh.md`; current evidence has no reusable escalation
      lifecycle across multiple workflows. Closed without filing by
      `reviews/2026-07-09-semstreams-beta145-runtime-reconcile-review.md`.
...
- [x] 9.6 File indexing profile/cardinality helper asks only after mixed COP feeds prove the need
      ...
      `reviews/2026-07-08-upstream-ask-deferral-refresh.md` and closed without filing by
      `reviews/2026-07-09-semstreams-beta145-runtime-reconcile-review.md`.
