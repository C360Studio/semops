...
- Require governed feed adapters for MAVLink, TAK/CoT, CAP, SAPIENT, ADS-B, KLV, and bidirectional CS API interop at
  the standards edge, while treating broader EDXL beyond CAP as a later product gate.
