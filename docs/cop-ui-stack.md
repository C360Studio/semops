...
an implemented control executor exist. The browser renders that guardrail as read-only policy state with inert
start/reset/pause/resume labels, not executable buttons.
